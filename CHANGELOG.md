...
[2026-03-18] FIX [middleware.ts] — Logout now redirects /admin/logout to /api/auth/logout. Previous approaches (cookie deletion via middleware redirect or pass-through) failed because Payload's RootPage refreshes the JWT cookie during rendering, overriding any Set-Cookie expire header.
